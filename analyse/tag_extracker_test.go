...
var (
	...
	Tags = [][]string{
		...
		{"和服", "喜欢", "日本"},
		{"雷猴", "人间", "回归"},
		{"工信处", "女干事", "24", "交换机", "科室", "亲口", "器件", "技术性", "下属", "交代", "每月", "安装", "经过", "工作"},
		{"廉租房", "需要"},
		{"饰品", "永和", "服装", "有限公司"},
		{"天安门", "北京"},
		{"abc"},
		{"马尔可夫"},
		{"雷猴", "网站"},
		{"SOFTware", "Microsoft", "MICROcomputer", "微型", "一词", "软件", "计算机", "组成", "部分"},
		{"草泥马", "欺实", "词汇", "流行", "今年"},
		{"洋华堂", "总府", "伊藤"},
		{"中国科学院计算技术研究所"},
		{"朱丽叶", "罗密欧"},
		{"道具", "服装", "购买"},
		{"自珍", "敞帚", "PS", "开源", "不断改进", "敦促", "好处", "避免", "能够", "觉得", "就是", "自己", "一个"},
		{"石首市", "湖北省"},
		{"十堰市", "湖北省"},
		{"总经理", "这件", "完成", "事情"},
		{"修好", "电脑"},
		...
		{"是因为", "国家"},
		{"老年", "搜索", "支持"},
		{"闲法", "中本", "laoshipukong", "RT", "27", "责任法", "蒙人", "万劫不复", "举证", "倒置", "医患", "那部", "拉倒", "侵权", "全国人大常委会", "草案", "境地", "纠纷", "删除", "弱势"},
		{},
		{},
		{"在理", "确实"},
		{"长春", "春节", "讲话", "市长"},
		...
		{"入口处", "机场"},
		{"邢永臣", "摄影", "报道"},
		{"区分度", "BP", "神经网络", "训练", "分类", "才能", "如何", "增加"},
		{"长江大桥", "南京市"},
		{"SMT", "NiuTrans", "使用者", "便于", "用于", "建议", "利用", "为了", "研究", "一些"},
		{"长春市", "药店", "长春"},
		{"邓颖超", "生前", "衣服", "喜欢"},
		{"政治局", "热爱", "常委", "胡锦涛", "和平", "世界"},
		{"右面", "孙健", "范凯", "李松洪", "朱会震", "海林", "左面", "程序员", "再往"},
		{"一次性", "多少"},
		{"四块", "五块", "三块", "一斤", "两块", "一本", "一套", "一条"},
		{"和尚", "和尚头", "一样", "一个"},
		{"和平门", "共和党", "地铁", "党员", "公民", "爸爸", "中华人民共和国"},
		{"张晓梅", "T恤", "B超", "医院", "人民", "然后"},
		{"offer", "AT&T", "不错", "一件", "公司"},
		{"c#", "PI", "C++", "3.14159", "133", "122", "11", "关系", "什么"},
		{"的士", "的哥", "他开", "握手", "一辆", "黑色", "主席", "认识", "那个"},
		{"枪杆子", "政权"},
	}
